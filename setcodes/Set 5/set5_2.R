...
#Compare Graphs
g_mu_50 / g_var_50 | g_mu_100 / g_var_100

#2 - excludes less than 10 cm in height
df_h10 <- df_h0 %>% 
  filter(height >= 10)
...
dfh10_50_histogram <- tibble(mu_hat_h10_50 = mu1_50, ub1var_hat_h10_50 = ub1_var50)

# histogram for mu1_50 & ub1_var50
g_mu_h10_50 <- dfh10_50_histogram %>% 
  ggplot(aes(x = mu_hat_h10_50)) +
  geom_histogram() +
  geom_vline(xintercept = mu)

g_var_h10_50 <- dfh10_50_histogram %>% 
  ggplot(aes(x = ub1var_hat_h10_50)) +
  geom_histogram() +
  geom_vline(xintercept = sigma2)

g_mu_h10_50 / g_var_h10_50

# histogram for mu1_100 & ub1_var100

dfh10_100_histogram <- tibble(mu_hat_h10_100 = mu1_100, ub1var_hat_h10_100 = ub1_var100)

g_mu_h10_100 <- dfh10_100_histogram %>% 
  ggplot(aes(x = mu_hat_h10_100)) +
  geom_histogram() +
  geom_vline(xintercept = mu)

g_var_h10_100 <- dfh10_100_histogram %>% 
  ggplot(aes(x = ub1var_hat_h10_100)) +
  geom_histogram() +
  geom_vline(xintercept = sigma2)

g_mu_h10_100 / g_var_h10_100

#Compare Graphs
g_mu_h10_50 / g_var_h10_50 | g_mu_h10_100 / g_var_h10_100
